...
- Clavier mobile masquant le champ de saisie actif quand il se trouve en bas d'écran (formulaire "Mes liaisons" et écran "Mon compte", y compris la modale de suppression de compte) : les autres écrans avec saisie texte (journal, connexion, RDV, messagerie…) avaient déjà `KeyboardAvoidingView`, ces deux écrans en manquaient — ajouté pour rester cohérent avec le reste de l'app (ML-69)
